...
public class MyDataLoader extends NativeImageLoader implements Serializable {
    ...
    public  MyDataLoader(String dataSetType){
        this(height,width,channels,null,dataSetType);
    }
    public MyDataLoader( ImageTransform imageTransform,String dataSetType){
       this (height,width,channels,imageTransform,dataSetType);
    }

    public  MyDataLoader(int height,int width,int channels, ImageTransform imageTransform,String dataSetType){
    ...
    public MultiDataSet  convertDataSet(int num) throws Exception {
        ...
        while (batchNumCount!=num && fileIterator.hasNext()){
            ...
            INDArray[] fratures=new INDArray[]{feature};
            ...
            multiDataSets.add(new MultiDataSet(fratures,labels,featuresMash,labelMask));
            batchNumCount++;
        }
    ...
    public  int totalExamples(){return  numExample;}
